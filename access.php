            ...
            <div id="block_settings" class="block_settings">
                ...
                <div class="open-accessibility">
                    <ul class="lab-wcag-settings clearfix">
                        ...
                        <li class="fontfamily-label">Gaya Tulisan</li>
                        <li>
                        ...
                        <li class="resizer-label">Ukuran Tulisan</li>
                        <li>
                            <ul class="access-float-font">
                                <li>
                                    <button class="lab-font-smaller">
                                        ...
                                        <span class="lab-only">Lebih Besar</span>
                                    </button>
                                </li>
                                <li>
                                    <button class="lab-font-larger">
                                        ...
                                        <span class="lab-only">Lebih Kecil</span>
                                    </button>
                                </li>
                                <li>
                                    <button class="lab-link-underline">
                                        ...
                                        <span class="lab-only">Garis Bawahi Link</span>
                                    </button>
                                </li>
                                <li>
                                    <button class="lab-font-readable">
                                        ...
                                        <span class="lab-only">Mudah Dibaca</span>
                                    </button>
                                </li>
                                <li>
                                    <button class="lab-font-normal">
                                        ...
                                        <span class="lab-only">Pengaturan Awal</span>
                                    </button>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <button class="lab-reset">
                                ...
                                <span class="lab-only">Setel Ulang Semua</span>
                            </button>
                        </li>
